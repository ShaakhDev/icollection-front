...
function Notification({ code, message, setNotification }) {
   ...
   return (
      <>
         <div
            className="bg-white border border-gray-200 border-solid  py-15 shadow-sm shadow-gray-200 rounded-lg  flex  items-start p-3   absolute top-8  animate-fade-in right-8 min-w-[30%]">
            {!isError &&
            ...
            {isError &&
               <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-red" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor" strokeWidth="2">
